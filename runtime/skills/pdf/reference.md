...
本文档包含高级 PDF 处理功能、详细示例以及主技能说明中未涉及的其他库。

## pypdfium2 库（Apache/BSD 许可证）

### 概述
pypdfium2 是 PDFium（Chromium 的 PDF 库）的 Python 绑定。它非常适合快速渲染 PDF、生成图片，并可作为 PyMuPDF 的替代品。
...
# 裁剪页面（left, bottom, right, top，单位为磅）
page = reader.pages[0]
