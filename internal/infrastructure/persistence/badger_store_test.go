...
func TestBadgerStore_PutNilVector(t *testing.T) {
	store := newTestBadgerStore(t)
	err := store.Put("key1", nil, nil)
	if err == nil {
		t.Fatal("expected error for nil vector")
	}
}

func TestBadgerStore_BatchPut(t *testing.T) {
	store := newTestBadgerStore(t)
...
func TestBadgerStore_BatchPutEmpty(t *testing.T) {
	store := newTestBadgerStore(t)
...
func TestBadgerStore_Search(t *testing.T) {
	store := newTestBadgerStore(t)
...
func TestBadgerStore_SearchWithThreshold(t *testing.T) {
	store := newTestBadgerStore(t)
...
func TestBadgerStore_SearchEmpty(t *testing.T) {
	store := newTestBadgerStore(t)
...
func TestBadgerStore_ScanEmptyPrefix(t *testing.T) {
	store := newTestBadgerStore(t)
...
func TestBadgerStore_PutWithMetadata(t *testing.T) {
	store := newTestBadgerStore(t)
